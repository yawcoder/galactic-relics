...
function Navbar() {
  ...
  return (
    <nav className="relative bg-gray-600 py-4 md:h-16 md:px-10 w-full">
        ...
        <div className={`${showLinks ? "max-h-[10rem]" : "max-h-0"} relative overflow-hidden top-[1rem] w-full duration-300 md:static md:overflow-visible`}>
          <button>
